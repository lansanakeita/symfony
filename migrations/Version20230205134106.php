 ...
 */
final class Version20230205134106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse ADD text_reponse VARCHAR(255) NOT NULL, ADD text_reponse1 VARCHAR(255) NOT NULL, ADD text_reponse2 VARCHAR(255) NOT NULL, ADD text_reponse3 VARCHAR(255) NOT NULL, ADD text_reponse4 VARCHAR(255) NOT NULL, DROP text_question, DROP text_question1, DROP text_question2, DROP text_question3, DROP text_question4');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse ADD text_question VARCHAR(255) NOT NULL, ADD text_question1 VARCHAR(255) NOT NULL, ADD text_question2 VARCHAR(255) NOT NULL, ADD text_question3 VARCHAR(255) NOT NULL, ADD text_question4 VARCHAR(255) NOT NULL, DROP text_reponse, DROP text_reponse1, DROP text_reponse2, DROP text_reponse3, DROP text_reponse4');
    }
}
